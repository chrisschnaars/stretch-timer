  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 w-full space-y-12 py-10">
      <div className="text-center space-y-2">
        <p className="text-fg-muted text-sm font-semibold uppercase tracking-widest">
          {currentIndex + 1} of {stretches.length}
        </p>
        <h2 className="text-4xl font-extrabold tracking-tight text-fg-primary">
          {currentStretch.name}
        </h2>
      </div>
        ...
        <div className="relative w-72 h-72 flex items-center justify-center">
          <svg className="absolute w-full h-full transform -rotate-90">
            ...
            <circle
              ...
              strokeLinecap="round"
              className="text-bg-accent transition-all duration-1000 ease-linear"
            />
          </svg>
